...
class RatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post rates_url, params: { rate: { eurclp: @rate.eurclp, gbpclp: @rate.gbpclp, provider: @rate.provider, usdclp: @rate.usdclp } }
    end
  ...
  test "should update rate" do
    patch rate_url(@rate), params: { rate: { eurclp: @rate.eurclp, gbpclp: @rate.gbpclp, provider: @rate.provider, usdclp: @rate.usdclp } }
